...
(defvar zenburn-default-colors-alist
  '(("zenburn-fg+1"     . "#FFFFEF")
    ...
    ("zenburn-white"   	. "#FFFFEF")
    ("zenburn-white-1"	. "#DCDCCC")
    ("zenburn-white-2"	. "#CCCCCC")
...
;;;;; org-mode
   ...
   `(org-done ((t (:bold t :foreground ,zenburn-green-1))))
   ...
   `(org-level-1 ((t (:foreground ,zenburn-white-1))))
   ...
   `(org-scheduled-today ((t (:foreground ,zenburn-blue+2))))
   `(org-sexp-date ((t (:foreground ,zenburn-blue+1 :underline t))))
   `(org-special-keyword ((t (:inherit font-lock-comment-face))))
   `(org-table ((t (:foreground ,zenburn-green+2))))
   `(org-tag ((t (:bold t :foreground ,zenburn-bg+3 :weight bold))))
   `(org-time-grid ((t (:foreground ,zenburn-orange))))
   `(org-todo ((t (:bold t :foreground ,zenburn-green-1))))
